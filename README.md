...
- ◎ **Education** · BSc (Hons) Computer Science, SLIIT City University, Colombo
- ⟳ **Learning** · Data structures & algorithms, and contributing to open source projects
- ✦ **Fun fact** · I once rebuilt an entire dashboard from scratch just to fix bugs I found during a code review

### Stack

**Languages**

<img src="https://skillicons.dev/icons?i=python,js,php,cpp,r,dart,html,css,java&theme=dark" alt="Languages"/>
